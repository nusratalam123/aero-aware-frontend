...
export default function ComparisonChart() {
  return (
    <Card className="bg-white/80 backdrop-blur">
      <CardHeader>
        <CardTitle className="text-lg font-semibold text-sky-900">Indoor vs Outdoor</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <YAxis stroke="#64748b" />
              <Tooltip />
              <Line type="monotone" dataKey="indoor" stroke="#0284c7" strokeWidth={2} />
              <Line type="monotone" dataKey="outdoor" stroke="#0ea5e9" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
